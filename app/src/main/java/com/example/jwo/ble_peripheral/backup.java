...
//private static final UUID ALARM_ELAPSED_UUID = UUID.fromString("733ACAB4-98B3-43BF-AE84-A9F9E3B15B15");
...
//        BluetoothGattService service =new BluetoothGattService(ALARM_SERVICE_UUID,
//        BluetoothGattService.SERVICE_TYPE_PRIMARY);
//
//        BluetoothGattCharacteristic elapsedCharacteristic =
//        new BluetoothGattCharacteristic(ALARM_ELAPSED_UUID,
//        //Read-only characteristic, supports notifications
//        BluetoothGattCharacteristic.PROPERTY_READ | BluetoothGattCharacteristic.PROPERTY_NOTIFY,
//        BluetoothGattCharacteristic.PERMISSION_READ);
//        BluetoothGattCharacteristic offsetCharacteristic =
//        new BluetoothGattCharacteristic(ALARM_CHARACTERISTIC_UUID,
...
//
//        if (ALARM_ELAPSED_UUID.equals(characteristic.getUuid())) {
...
//        .addServiceUuid(new ParcelUuid(ALARM_SERVICE_UUID))
//        .build();
//
...
//        .getCharacteristic(ALARM_ELAPSED_UUID);
